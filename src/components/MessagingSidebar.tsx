...
const MessagingSidebar = ({ onSelectConversation, selectedBookingId, className = '' }: MessagingSidebarProps) => {
  ...
  if (isLoading) {
    return (
      <Card className={`w-80 h-full flex items-center justify-center ${className}`}>
    ...
    <Card className={`w-80 h-full flex flex-col ${className}`}>
      ...
      <div className="p-4 border-b bg-background">
        ...
        <div className="flex gap-1">
          ...
          <Button
            variant={filterStatus === 'assigned' ? 'default' : 'ghost'}
            size="sm"
          ...
          {filteredConversations.length === 0 ? (
            <div className="flex items-center justify-center h-full min-h-[300px]">
              <div className="text-center p-6">
                ...
                <h3 className="font-semibold mb-2 text-sm">No conversations</h3>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          <span className="text-xs text-muted-foreground">
                            {getStatusIcon(conversation.booking.status)}
                          </span>
                      ...
                      {conversation.last_message ? (
                        ...
                        <div className="flex items-center gap-1 text-xs text-muted-foreground">
                          ...
                          <span>
                            {new Date(conversation.booking.scheduled_date).toLocaleDateString()}
                          </span>
                        </div>
                      )}
                    </div>
